...
-- Update the user deletion function to include AI enrichment data
...
BEGIN
  ...
  -- Delete from entry_enrichment table (NEW)
...
-- Update the dry run function to include entry_enrichment as well
